...
import com.runtai.boomlibrary.Types.StateType;
...
public class BoomMenuButton extends FrameLayout
    ...
    private void shoot() {
        ...
        // listener
        if (onClickListener != null) onClickListener.onClick(getId());
    ...
    public TextView[] getTextViews() {
        ...
        Log.i("isInList",""+isInList);
        Log.i("MEMORY_OPTIMIZATION",""+MEMORY_OPTIMIZATION);
        if (isInList && MEMORY_OPTIMIZATION) {
    ...
    public void onClick(int index) {
        ...
        if (onSubButtonClickListener != null) onSubButtonClickListener.onClick(index);//这里获取到子控件的index，返回到MainActivity
    ...
    public static class Builder {
        ...
        public BoomMenuButton init(BoomMenuButton boomMenuButton) {
            Log.e("boomMenuButton",""+boomMenuButton.getId());
